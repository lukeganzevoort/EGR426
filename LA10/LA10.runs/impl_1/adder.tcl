...
set rc [catch {
  ...
  add_files -quiet C:/Users/Luke/Documents/EGR426/LA10/LA10.runs/synth_1/adder.dcp
...
set rc [catch {
  ...
  report_drc -file adder_drc_routed.rpt -pb adder_drc_routed.pb -rpx adder_drc_routed.rpx
  report_methodology -file adder_methodology_drc_routed.rpt -rpx adder_methodology_drc_routed.rpx
