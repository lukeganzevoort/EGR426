...
#
# Generated by export_simulation on Thu Feb 16 19:17:23 -0500 2017
#
################################################################################
...
switch to the './four_bit_count.sh' script.

./four_bit_count.sh -reset_run
...
./four_bit_count.sh -noclean_files

For more information on the script, please type './four_bit_count.sh -help'.
