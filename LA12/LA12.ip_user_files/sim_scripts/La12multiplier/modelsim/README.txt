...
#
# Generated by export_simulation on Thu Apr 06 17:45:46 -0400 2017
#
################################################################################
...
switch to the './La12multiplier.sh' script.

./La12multiplier.sh -reset_run
...
./La12multiplier.sh -noclean_files

For more information on the script, please type './La12multiplier.sh -help'.
