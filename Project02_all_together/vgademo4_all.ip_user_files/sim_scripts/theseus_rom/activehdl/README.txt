...
#
# Generated by export_simulation on Fri Mar 10 16:29:15 -0500 2017
#
################################################################################
...
switch to the './theseus_rom.sh' script.

./theseus_rom.sh -reset_run
...
./theseus_rom.sh -noclean_files

For more information on the script, please type './theseus_rom.sh -help'.
